...
export function ProfileSetupForm({ initial }: Props) {
  const [state, action] = useActionState(completeProfileAction, idleState);
  ...
  return (
    <form action={action} className="space-y-5" noValidate>
      ...
      <ImageUpload
        ...
        shape="circle"
        label="Profile photo"
        hint="Optional. Your partner will see this."
      />
      ...
      <Field
        ...
        htmlFor="nickname"
        optional
        hint="What your partner calls you."
